...
import net.myfigurecollection.Fragments.PagerFragment;
...
public class MainActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRoot = savedInstanceState.getInt("root", 0);
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container, PagerFragment.newInstance(position - 1))
                .commit();
    ...
    public void onSectionAttached(int number) {
        mStatus = number;
        if (mTabStrip != null) mTabStrip.setVisibility(View.VISIBLE);
